...
export default function Index() {
  ...
  let scrapeWebsite = async () => {
    ...
    let response = await fetch(`/api/${workspaces[workspaceId].isPuppetter ? "pptr" : "dom"}`, {
      method: "POST",
      body: bodyContent,
      headers: headersList,
    });
  ...
  return (
    <main className="flex-grow mb-6 transition-all h-full justify-start flex w-full gap-6 flex-row pt-4 max-md:flex-col items-start max-md:px-2 mx-auto px-4 pl-[265px]">
        ...
        <div className="flex flex-row justify-between items-center">
          ...
          <div className="flex flex-row items-center gap-2">
            ...
            <button
              ...
              onClick={() => {
                workspaces[workspaceId].isPuppetter =  !workspaces[workspaceId].isPuppetter;
                setWorkspaces([...workspaces]);
              }}
            >
              Puppetter
